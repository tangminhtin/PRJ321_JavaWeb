<%-- 
    Document   : index
    Created on : Jul 10, 2020, 6:19:14 PM
    Author     : tangminhtin
--%>
    ...
    <body>
        ...
        <c:if test="${!empty param.btnAdd}">
            ...
            <c:if test="${!empty param.txtFullname && !empty param.txtAddress}">
                ...
                <!--Ket noi CSDL-->
                <sql:setDataSource var="conn" scope="session" url="jdbc:mysql://localhost/jsp" user="root" password="" driver="com.mysql.jdbc.Driver"/>
               
                <!--Tao cau lenh insert-->
                <sql:update dataSource="${conn}" var="result" scope="session" sql="INSERT INTO Users(fullname, address) VALUES (?, ?)">
        ...
        <form method="post">
            <div class="container">
                ...
                <input type="text" placeholder="Enter your address name" name="txtAddress" required>
            </div>
